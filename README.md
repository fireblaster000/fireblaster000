...
<div align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=30&duration=3000&pause=1000&color=36BCF7&center=true&vCenter=true&width=800&lines=MS+CS+Student+at+Dartmouth+College+🎓;AI+Research+Scientist+%2B+Full+Stack+Developer+💻;Multi-Agent+Systems+%26+Computer+Vision+Expert+🤖;Building+the+Future+with+AI+%26+Code+🚀" alt="Typing SVG" />
</div>
...
class GradStudent:
    def __init__(self):
        self.name = "Muhammad Ibrahim Farrukh"
        self.status = "MS CS Student @ Dartmouth College"
        self.location = "Hanover, NH"

        self.research_interests = [
            "Multi-Agent Systems", "Large Language Models",
            "Computer Vision", "3D Reconstruction", "Federated Learning",
            "AR/VR Applications", "Sports Analytics"
        ]

        self.current_mission = "Transforming research into production-ready solutions"
        self.fun_fact = "Can debug any issue into a working solution 📸➡️🏛️"

    def get_current_focus(self):
        return {
            "🔬 Research": "Multi-Agent LLM Navigation & FL Optimization",
            "💻 Development": "AI-powered platforms & AR applications",
            "🏈 Side Projects": "FPL ML predictions & trading platforms",
            "🎯 Goal": "World changing Startup Founder"
        }
```
